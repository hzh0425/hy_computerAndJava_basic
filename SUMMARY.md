...
- [3.递归算法题目集](算法/3.递归例题.md)
- [4.二分算法](算法/4.二分算法.md)
- [4.二分算法题目集](算法/4.二分题目集.md)
- [动态规划系列]()
- [1.动态规划基础](算法/7.动态规划⭐.md)
- [2.动态规划-子序列类型](算法/7.子序列类型dp.md)
- [3.动态规划-背包类型](算法/dp/背包.md)
- [4.动态规划-博弈类型](算法/dp/博弈型.md)

### java基础

- [java反射机制](basic/jdk/0.反射机制.md)
- [jdk动态代理机制](basic/jdk/0.JDK动态代理.md)
- [异常]
- [IO]
